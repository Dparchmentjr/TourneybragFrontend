# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2017-04-06 04:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Tournament',
            fields=[
                ('organizer_owner', models.CharField(max_length=30)),
                ('tournament_title', models.CharField(max_length=30, primary_key=True, serialize=False, unique=True)),
                ('date_created', models.DateTimeField(verbose_name='date_created')),
                ('date_start', models.DateTimeField(verbose_name='start date')),
                ('organizer_ownerID', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='tourneyBrag.Organizer')),
            ],
        ),
        migrations.CreateModel(
            name='Voucher',
